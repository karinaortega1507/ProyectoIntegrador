        ...
        <IonSplitPane contentId="main">
          ...
          <IonRouterOutlet id="main">
            ...
            <Route
              ...
              component={MedidaProteccion}
            ></Route>
            <Route
              exact
              path="/comportamiento-agresivo"
              component={Comportamiento}
            ></Route>
            <Route
              exact
              path="/agregar-contactos"
              component={AgregarContactos}
            ></Route>
            <Route
              exact
              path="/seguimiento-proceso"
              component={SeguimientoProceso}
            ></Route>
            <Route
              exact
